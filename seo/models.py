...
class PageSeo(models.Model):
    ...
    title = models.CharField(
        max_length=750, null=True, blank=True, verbose_name='Title',
    ...
    additional_html = models.TextField(
        verbose_name='Дополнительное', null=True, blank=True,
...
class SitePageSeo(PageSeo):
    ...
    h1 = models.CharField(max_length=500, verbose_name='H1', null=True, blank=True)
